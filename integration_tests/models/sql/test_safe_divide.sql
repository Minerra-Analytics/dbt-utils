...
select
    {{ dwa.safe_divide('numerator', 'denominator') }} as actual,
    output as expected
...
select
    {{ dwa.safe_divide('numerator_1 * numerator_2', 'denominator') }} as actual,
    output as expected
...
select
    {{ dwa.safe_divide('numerator', 'denominator_1 * denominator_2') }} as actual,
    output as expected
